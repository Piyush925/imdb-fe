                    ...
                    <div>
                        <div className="auth-wrapper">
                            <div className="auth-innerd" >
                                ...
                                }} placeholder="Actors" options={this.props.actoroptions} multi={true} />
                                <Select style={{ height: '42px', width: '400px', float: "left" }} placeholder="Actress" onChange={async (value) => {
                                    ...
                                    this.props.actor.length > 0 || this.props.actress.length > 0 ?
                                        await this.props.filter(data) : this.props.dashboard();
                                }} options={this.props.actressoptions} multi={true} />
                                <Dropdown className="cdtasks" id="role" options={this.props.directoroptions} onChange={async (value) => {
                                ...
                                <Dropdown className="cdtasks" id="role" options={this.props.produceroptions} onChange={async (value) => {
                                ...
                                <Dropdown className="cdtasks" options={this.props.yearoptions} onChange={this.props.setYear}
                                    value={this.props.year} placeholder="Release Year" />
                                <Dropdown className="cdtasks" options={this.props.ratingoptions} onChange={this.props.setRating}
                                        ...
                                        <div key={key} >
                                            <Card style={{ width: 220, height: 450 }} >
                                                <CardHeader style={{ width: 220, height: 100 }}>
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <label onClick={() => {
                                                        this.props.deletemovie(item.id);
                                                        this.props.dashboard();
                                                        this.setState({ limit: this.state.limit })
                                                    }} style={{ float: "right" }}>X</label>
                                                </CardHeader>
