                ...
                <form>
                    <div>
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" ref={this.name} className="form-control" placeholder="Actor name" onChange={this.props.onNameChange} value={this.props.name} title="Must be Alphabet" required />
                        </div>
                        <div className="form-group">
                            <label>Age</label>
